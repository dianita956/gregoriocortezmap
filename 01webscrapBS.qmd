...
On this page the each code block is define a function roles of what we want the function to do. This process helps with automating web scraping, where we can replace the website URL and filename. 
